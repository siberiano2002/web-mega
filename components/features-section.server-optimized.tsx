...
export function FeatureCard({ feature }: { feature: typeof features[0] }) {
  return (
    ...
    >
      {/* Icon */}
      <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-lg sm:rounded-xl bg-muted flex items-center justify-center mb-3 sm:mb-6 group-hover:bg-accent/10 transition-colors">
        <feature.icon className="h-5 w-5 sm:h-6 sm:w-6 lg:h-7 lg:w-7 text-foreground group-hover:text-accent transition-colors" />
      </div>
