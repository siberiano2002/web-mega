...
// ✅ LCP Optimized: Configuración de imágenes responsive con tamaños específicos
...
// ✅ LCP Optimized: Blur placeholder generado una vez
const LCP_BLUR_PLACEHOLDER = "data:image/jpeg;base64,"

export function HeroSectionLCPOptimized() {
  const [loaded, setLoaded] = useState(false)
  const [screenSize, setScreenSize] = useState('desktop')

  // ✅ LCP Optimized: Memoizar configuración de imagen actual
  const currentImageConfig = useMemo(() => {
    switch (screenSize) {
      case 'mobile': return LCP_IMAGE_CONFIG.mobile
      case 'tablet': return LCP_IMAGE_CONFIG.tablet
      default: return LCP_IMAGE_CONFIG.desktop
    }
  }, [screenSize])
  ...
  useEffect(() => {
    ...
    // ✅ LCP Optimized: Resize con debounce para no afectar LCP
  ...
  return (
    <section id="inicio" className="relative min-h-[70vh] sm:min-h-[80vh] lg:min-h-[90vh] flex items-center overflow-hidden pt-20 sm:pt-24 lg:pt-32 pb-8 sm:pb-12 lg:pb-16">
      {/* ✅ LCP Optimized: Background Image con máxima prioridad */}
      <div className="absolute inset-0">
        <Image
          ...
          sizes={currentImageConfig.sizes}
          priority={true}                    // ✅ LCP: Máxima prioridad
          loading="eager"                    // ✅ LCP: Carga inmediata
          placeholder="blur"                 // ✅ LCP: Placeholder para mejor UX
          blurDataURL={LCP_BLUR_PLACEHOLDER}  // ✅ LCP: Blur optimizado
          quality={90}                       // ✅ LCP: Calidad alta para LCP
          fetchPriority="high"               // ✅ LCP: Fetch prioritizado
        />
        
        {/* ✅ LCP Optimized: Overlays para mejorar contraste sin afectar carga */}
