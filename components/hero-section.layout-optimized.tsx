...
import { useOptimizedScroll, useOptimizedResize } from "@/hooks/layout-optimized-hooks"
...
export function HeroSection() {
  ...
  const handleResize = useOptimizedResize(() => {
    updateScreenSize()
  }, 250)
  ...
  // ✅ Función optimizada para actualizar tamaño de pantalla
  const updateScreenSize = () => {
    // ✅ Usar innerWidth en lugar de getBoundingClientRect para evitar layout thrashing
  ...
  useEffect(() => {
    ...
    // ✅ Usar handleResize optimizado con debouncing
